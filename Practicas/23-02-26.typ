...
#doubt[
  Entonces entiendo que decir:
  거실에 가요
  거실에서 가요
  Ambos tienen sentido? Por lo que entiendo, en el primero estoy
  diciendo que voy *a la sala* y en el segundo estoy diciendo que
  *voy de la sala*, dando a entender que voy a otro lugar de forma
  implicita
][
